...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { //8
        getMenuInflater().inflate(R.menu.main, menu); //9
        return  true; //10
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_search) {
            Context ctxt = MainActivity.this;
            String msg = "search clicked working..";
            Toast.makeText(ctxt,msg, Toast.LENGTH_LONG).show();
            //we are making toast message and showing it using show function.
        }
